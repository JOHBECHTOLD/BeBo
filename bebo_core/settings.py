"""
Django settings for bebo_core project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'bebo_core.context_processors.bebo_version', 
            ],
        },
    },
]

WSGI_APPLICATION = 'bebo_core.wsgi.application'
...
# WhiteNoise auch für Media-Dateien (Production)
