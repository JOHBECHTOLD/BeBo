...
urlpatterns = [
    ...
    path('box/add/', BoxCreateView.as_view(), name='box_create'),                               # 1.6.0 Feature (Alias)
    ...
    # --- SONSTIGES (Bilder, Historie, Changelog) ---
    path('image/<int:image_id>/delete/', image_delete, name='image_delete'),
